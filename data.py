...
class DATA():
    ...
    def read_img(self, filename):
        ...
        labimg = cv2.cvtColor(cv2.resize(img, (param.IMAGE_SIZE, param.IMAGE_SIZE)), cv2.COLOR_RGB2Lab) ## Changed BGR to RGB
        return np.reshape(labimg[:,:,0], (1, param.IMAGE_SIZE, param.IMAGE_SIZE)), np.reshape(labimg[:, :, 1:], (2,param.IMAGE_SIZE, param.IMAGE_SIZE))
